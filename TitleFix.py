...
# ИЗМЕНЕНИЕ СТИЛЯ ПО УМОЛЧАНИЮ
    ...
    #pattern = ['2023', '20__', 'Тезисы', 'по дисциплине', 'Тема', 'Подготовил', 'старший преподаватель', 'майор', 
    #            'Методическая разработка обучающимся', 'для лабораторного занятия', 'для практического занятия', 'для семинарского занятия']
    #replace = ['2024', '2024', 'Текст', 'по учебной дисциплине', 'по теме', 'Разработал', 'доцент', 'подполковник', 
